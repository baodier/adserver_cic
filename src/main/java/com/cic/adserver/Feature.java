...
public class Feature {
    ...
    public Feature(String adid_tmp, String browser_tmp, String os_tmp, int hour_tmp, String region_tmp, double sim_title_tmp, double sim_keyword_tmp, int matchType_tmp){
        adid = adid_tmp;
        browser = browser_tmp;
        os = os_tmp;
        hour = hour_tmp;
